...
export default function Header() {
  ...
  return (
    <nav className={`${isScrolled ? "md:flex" : "hidden"} justify-between items-center pr-8 z-10 w-full fixed transition-all duration-300 ${isScrolled ? 'bg-white text-black shadow-md' : 'bg-transparent md:text-white pt-1'}`}>
      <motion.h1
